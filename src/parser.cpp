...
Args parseArgs(int argc, char* argv[]) {
    ...
    try {
        ...
        TCLAP::ValueArg<std::string> binaryArg("b", "bin", "Binary to launch (llama-swap | llama-server)", false, "", "string");
        ...
        TCLAP::ValueArg<std::string> kvValueArg("w", "kv-value", "Value quantization", false, "", "string");
